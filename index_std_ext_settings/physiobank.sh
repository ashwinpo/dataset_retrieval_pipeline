curl -XDELETE '127.0.0.1:9200/physiobank_std_ext_val?pretty&pretty'
curl -XGET '127.0.0.1:9200/physiobank_std_ext_val?v&pretty'
curl -XPUT '127.0.0.1:9200/physiobank_std_ext_val?pretty' -d'
{
  "settings" : {
    "number_of_shards" : 5,
