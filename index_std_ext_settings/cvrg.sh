curl -XDELETE '127.0.0.1:9200/cvrg_std_ext_val?pretty&pretty'
curl -XGET '127.0.0.1:9200/cvrg_std_ext_val?&pretty'
curl -XPUT '127.0.0.1:9200/cvrg_std_ext_val?pretty' -d'
{
  "settings" : {
      "number_of_shards" : 5,
