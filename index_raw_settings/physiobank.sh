curl -XDELETE '127.0.0.1:9200/physiobank_raw?pretty&pretty'
curl -XGET '127.0.0.1:9200/physiobank_raw?v&pretty'
curl -XPUT '127.0.0.1:9200/physiobank_raw?pretty' -d'
{
  "settings" : {
    "number_of_shards" : 5,
