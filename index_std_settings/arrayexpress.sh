curl -XDELETE '127.0.0.1:9200/arrayexpress_std?pretty&pretty'
curl -XGET '127.0.0.1:9200/arrayexpress_std?&pretty'
curl -XPUT '127.0.0.1:9200/arrayexpress_std?pretty' -d'
{
  "settings" : {
      "number_of_shards" : 5,
