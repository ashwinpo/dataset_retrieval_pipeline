curl -XDELETE '127.0.0.1:9200/bioproject_std?pretty&pretty'
curl -XGET '127.0.0.1:9200/bioproject_std?&pretty'
curl -XPUT '127.0.0.1:9200/bioproject_std?pretty' -d'
{
  "settings" : {
      "number_of_shards" : 5,
