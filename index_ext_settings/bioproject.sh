curl -XDELETE '127.0.0.1:9200/bioproject_ext_nostd?pretty&pretty'
curl -XGET '127.0.0.1:9200/bioproject_ext_nostd?&pretty'
curl -XPUT '127.0.0.1:9200/bioproject_ext_nostd?pretty' -d'
{
  "settings" : {
      "number_of_shards" : 5,
